...
function calculateCellWinner(x, y, points, { rangeCutoff, rangeCutoff2, numberCutoff }) {
  const scores = {}
  let highestScore = 0,
    highestParticipant = ''
...
async function makeCanvas({
  ...
  const [cellsWide, cellsHigh] = [clientRect.width / cellSize, clientRect.height / cellSize]
